...
func TestGenImageKernelOptions(t *testing.T) {
	...
	rootUUID, cmdline, err := GenImageKernelOptions(pt, false, true)
	assert.NoError(err)
...
func TestGenImageKernelOptionsBtrfs(t *testing.T) {
	...
	_, actual, err := GenImageKernelOptions(pt, false, true)
...
func TestGenImageKernelOptionsBtrfsNotRootCmdlineGenerated(t *testing.T) {
	...
	_, kopts, err := GenImageKernelOptions(pt, false, true)
...
func TestGenImageKernelOptionsMountUnitsPlain(t *testing.T) {
	...
	rootUUID, cmdline, err := GenImageKernelOptions(pt, true, true)
	assert.NoError(err)
...
func TestGenImageKernelOptionsMountUnitsPlainWithUsr(t *testing.T) {
	...
	rootUUID, cmdline, err := GenImageKernelOptions(pt, true, false)
	assert.NoError(err)
